...
{
class RoundaboutConfigurationValidator : public lanelet::validation::MapValidator
{
public:
  // Write the validator's name here
  constexpr static const char * name() { return "mapping.intersection.roundabout_configuration"; }

  lanelet::validation::Issues operator()(const lanelet::LaneletMap & map) override;

private:
  lanelet::validation::Issues check_roundabout_configuration(const lanelet::LaneletMap & map);
};
}  // namespace lanelet::autoware::validation
