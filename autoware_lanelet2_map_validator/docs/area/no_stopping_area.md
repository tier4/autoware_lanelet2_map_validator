...
| Area.NoStoppingArea-004 | This no_stopping_area regulatory element must refer to at most one stop_line.                     | Error    | regulatory element | Regulatory element refers to more than one stop_line  | Check referenced stop_lines    |
