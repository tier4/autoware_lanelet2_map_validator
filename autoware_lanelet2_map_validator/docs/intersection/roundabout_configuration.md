...
1. All internal lanelets are properly connected between entry and exit lanelets
2. All possible routes from entry to exit lanelets consist only of entry, exit, or internal lanelets
